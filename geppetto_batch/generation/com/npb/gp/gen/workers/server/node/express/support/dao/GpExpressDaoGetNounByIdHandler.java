 ...
 */
@Component("GpExpressDaoGetNounByIdHandler")
public class GpExpressDaoGetNounByIdHandler extends
...
IGpExpressDaoVerbGenSupport {
	...
	public void gp_verb_key(GpVerb verb, GpActivity activity) throws Exception {
		the_dto.verb_key_name = GpSqlQueriesGenSupport.key_name_for_get_by_id;
	}
	
	@Override
	public void gp_sql_query(GpVerb verb,GpActivity activity) throws Exception {
		GpNoun the_noun = activity.getPrimary_noun();
		the_dto.query_replacements = "replacements: { id: " + the_noun.getName() + "_id" + "},"; // no replacements for this
