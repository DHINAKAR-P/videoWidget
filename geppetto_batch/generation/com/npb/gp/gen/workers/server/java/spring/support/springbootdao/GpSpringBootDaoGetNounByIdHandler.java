 ...
 */
@Component("GpSpringBootDaoGetNounByIdHandler")
public class GpSpringBootDaoGetNounByIdHandler extends
...
IGpSpringBootDaoVerbGenSupport {
	...
	public void gp_jpa_query(GpVerb verb,GpActivity activity) throws Exception {
		...
		for (GpBaseSqlDto stmt_dto : sql_stmts) {
			if (stmt_dto.verb_action_on_data.equals(GpBaseVerbsConstants.GpGetNounById)) {
