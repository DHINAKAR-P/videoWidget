 ...
 */
@Component("GpSpringBootControllerGetNounByIdHandler")
public class GpSpringBootControllerGetNounByIdHandler extends
...
IGpSpringBootControllerVerbGenSupport {
	...
	public void get_function_signiture(GpVerb verb,GpActivity activity,HashMap<String, GpServiceVerbGenInfo> service_methods) throws Exception {
		...
		the_dto.request_map_value = "get_" + activity.getPrimary_noun().getName()	+ "_by_id" + "/{" + activity.getPrimary_noun().getName() + "_id" +"}";
		the_dto.reference_request_map_value = "get_" + activity.getPrimary_noun().getName()	+ "_by_id";
		the_dto.method_name = "get_" + activity.getPrimary_noun().getName()	+ "_by_id";
