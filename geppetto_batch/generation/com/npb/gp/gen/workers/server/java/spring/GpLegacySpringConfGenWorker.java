 ...
 *
 */
@Component("GpLegacySpringConfGenWorker")
public class GpLegacySpringConfGenWorker extends GpGenJavaServerSpringBaseWorker {
...
*/
	...
	private void set_up_paths_and_templates_spring_conf(){
		...
		String spring_legacy_config_file_template_location = this.base_configs
			.get("spring_legacy_config_file_template_location").getValue();


		tokens = this.tokenize_string(
				spring_legacy_config_file_template_location, null);
		...
		if(spring_legacy_config_file_template_location_path_config  == null){
			...
			String template_name =  this.base_configs.get(
					"spring_legacy_config_file_template_name").getValue();
