...
@Component("GpExpressDaoDeleteByParentIdHandler")
public class GpExpressDaoDeleteByParentIdHandler extends
...
IGpExpressDaoVerbGenSupport {
	...
	public void gp_verb_key(GpVerb verb,GpActivity activity) throws Exception {
		the_dto.verb_key_name = GpSqlQueriesGenSupport.key_name_for_delete_by_parent_id;
	}
	...
	public void gp_sql_query(GpVerb verb, GpActivity activity) throws Exception{
		...
		the_dto.sequelizeQueryType = "DELETE";
	}
