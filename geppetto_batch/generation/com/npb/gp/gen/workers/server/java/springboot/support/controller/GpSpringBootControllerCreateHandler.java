...
@Component("GpSpringBootControllerCreateHandler")
public class GpSpringBootControllerCreateHandler 
extends GpBaseSpringBootControllerVerbFunctionHandler
	...
	public void gp_declare_noun(GpVerb verb, GpActivity activity,HashMap<String, GpServiceVerbGenInfo> service_methods) throws Exception {
		GpJavaMethodDescription method_description =  service_methods
				.get(GpBaseVerbsConstants.GpCreate).signiture_helper;
	...
	public void get_function_signiture(GpVerb verb,GpActivity activity,HashMap<String, GpServiceVerbGenInfo> service_methods) throws Exception {
		...
		the_dto.request_map_value = "create_" + activity.getPrimary_noun().getName();
		the_dto.reference_request_map_value = "create_" + activity.getPrimary_noun().getName();
		the_dto.method_name = "create_" + activity.getPrimary_noun().getName();
		the_dto.input_parms = "@RequestBody "+ activity.getPrimary_noun().getName() + " the_"+ activity.getPrimary_noun().getName();
		GpJavaMethodDescription method_description = service_methods.get(GpBaseVerbsConstants.GpCreate).signiture_helper;
