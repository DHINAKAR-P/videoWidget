...
@Component("GpExpressControllerGetNounByParentIdHandler")
public class GpExpressControllerGetNounByParentIdHandler extends
...
IGpExpressControllerVerbGenSupport {
	...
	public void gp_service_call(GpVerb verb,GpActivity activity) throws Exception {
		...
		//System.out.println(the_map.toString());
		ServiceFunctionDescription serviceFunctionDescription = the_map.get(GpBaseVerbsConstants.GpGetNounByParentId);
