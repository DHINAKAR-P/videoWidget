...
@Component("GpJpaDaoGenSupport")
public class GpJpaDaoGenSupport {
	private GpFlowControl the_flow;
	private GpJpaDaoVerbMethodSignitures method_signitures_hlpr;
	private GpJpaDaoVerbMethodImplementations implementation_hlpr;
	private GpSpringJpaDaoGenWorker the_worker;
	
	public GpJpaDaoVerbMethodImplementations getImplementation_hlpr() {
		return implementation_hlpr;
	}

	@Resource(name="GpJpaDaoVerbMethodImplementations")
	public void setImplementation_hlpr(
			GpJpaDaoVerbMethodImplementations implementation_hlpr) {
	...
	public GpJpaDaoVerbMethodSignitures getMethod_signitures_hlpr() {
		return method_signitures_hlpr;
	}

	@Resource(name="GpJpaDaoVerbMethodSignitures")
	public void setMethod_signitures_hlpr(
			GpJpaDaoVerbMethodSignitures method_signitures_hlpr) {
	...
	public ArrayList<GpJpaDaoVerbGenInfo> get_verb_method_implmentation(
															GpActivity activity){
		this.implementation_hlpr.setThe_worker(this.the_worker);
		ArrayList<GpJpaDaoVerbGenInfo> implementations = new ArrayList<GpJpaDaoVerbGenInfo>();

		ArrayList<GpVerb> the_verbs = activity.getTheverbs();
		List<String> generated_verbs = new ArrayList<String>();
		for(GpVerb a_verb : the_verbs){
			if(a_verb.getAction_on_data().equals("GpGetAllValues") && !generated_verbs.contains("GpGetAllValues")){
				GpJpaDaoVerbGenInfo impl = this.implementation_hlpr
			...
			if(a_verb.getAction_on_data().equals("GpUpdate") && !generated_verbs.contains("GpUpdate")){
				GpJpaDaoVerbGenInfo implicit_verb = this.implementation_hlpr
							.search_for_update_implementation(a_verb, activity);
