 ...
 * 
 */
@Component("GpServiceSpringBootVerbMethodSignitures")
public class GpServiceSpringBootVerbMethodSignitures {
	...
	public GpJavaMethodDescription delete_nound_by_parent_id_method_signiture(GpActivity an_activity,
		...
		// NEW WAY - METHOD NAME
		full_signiture.setName("delete_"
				+ an_activity.getPrimary_noun().getName().toLowerCase() + "_by_parent_id");
		full_description = full_description + " " + "delete_"
				+ an_activity.getPrimary_noun().getName().toLowerCase()  + "_by_parent_id";
