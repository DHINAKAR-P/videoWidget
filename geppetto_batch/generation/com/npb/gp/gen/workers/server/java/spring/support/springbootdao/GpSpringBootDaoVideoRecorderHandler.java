...
@Component("GpSpringBootDaoVideoRecorderHandler")
public class GpSpringBootDaoVideoRecorderHandler extends GpBaseSpringBootDaoVerbFunctionHandler
implements IGpSpringBootDaoVerbGenSupport {
	...
	private GpSpringBootDaoVerbGenInfo gp_update(GpVerb verb, GpActivity activity) throws Exception {
		GpSpringBootDaoVerbGenInfo search_for_update = the_update_handler.handle_implicit_verb(verb, activity);
