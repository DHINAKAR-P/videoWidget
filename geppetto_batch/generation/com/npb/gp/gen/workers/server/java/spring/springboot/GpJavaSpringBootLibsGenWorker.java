...
@Component("GpJavaSpringBootLibsGenWorker")
public class GpJavaSpringBootLibsGenWorker extends GpGenJavaServerSpringBaseWorker{
	...
	public void move_libs() throws Exception{
			...
			String base_directory2 = this.base_configs.get("root_code_template_location").getValue() + this.file_separator + "server" + this.file_separator + "java" + this.file_separator + "springbootlib";
			Path spring_boot_web_path = (Path) this.derived_configs
					.get(GpGenConstants.SPRING_BOOT_RESOURCE_PATH).getObject_value();
			
			String directory_libs = spring_boot_web_path.toString() + this.file_separator + "lib";			
