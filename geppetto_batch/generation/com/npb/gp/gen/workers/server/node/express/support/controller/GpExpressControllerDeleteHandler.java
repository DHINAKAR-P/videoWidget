 ...
 */
@Component("GpExpressControllerDeleteHandler")
public class GpExpressControllerDeleteHandler extends
	...
	@Override
	public void gp_variable_statement(GpVerb verb,GpActivity activity){
		GpNoun the_noun = activity.getPrimary_noun();
