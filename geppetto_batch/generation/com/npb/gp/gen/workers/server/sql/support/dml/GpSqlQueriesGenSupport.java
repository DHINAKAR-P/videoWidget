package com.npb.gp.gen.workers.server.sql.support.dml;
...
@Component("GpSqlQueriesGenSupport")
public class GpSqlQueriesGenSupport {
	...
	public GpBaseSqlDto create_dml_stmt(GpActivity activity, Map<Long, JSONArray> relationships_map) throws JSONException {
		...
		create_clause += "created_by, updated_by,";
	...
	public GpBaseSqlDto update_dml_stmt(GpActivity activity, Map<Long, JSONArray> relationships_map) throws JSONException {
		...
		ArrayList<GpNounAttribute> attribs = activity.getPrimary_noun().getNounattributes();
		for(GpNounAttribute attrib : attribs){
			if(attrib.getSubtype().equals(GpNounConstants.SUB_TYPE_NOUN) 
					|| attrib.getSubtype().equals(GpNounConstants.SUB_TYPE_LIST) 
					||attrib.getSubtype().equals(GpNounConstants.SUB_TYPE_PICTURE)
					||attrib.getSubtype().equals(GpNounConstants.SUB_TYPE_VIDEO)){
				continue;
			}
		...
		update_clause += " updated_date=NOW(),";
		update_clause += " updated_by=:updated_by,";
