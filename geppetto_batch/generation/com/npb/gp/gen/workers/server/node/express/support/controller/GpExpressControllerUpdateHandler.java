...
@Component("GpExpressControllerUpdateHandler")
public class GpExpressControllerUpdateHandler extends 
	...
	private List<ControllerFunctionDescription> the_implicit_verbs;
	...
	private ControllerFunctionDescription gp_search_for_update(GpVerb verb, GpActivity activity) throws Exception {
		ControllerFunctionDescription search_for_update = the_search_for_update_handler.handle_implicit_verb(verb, activity);
	...
	public List<ControllerFunctionDescription> getThe_implicit_verbs() {
