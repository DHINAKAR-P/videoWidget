 ...
 *
 */
@Component("GpLegacyBaseClassesGenWorker")
public class GpLegacyBaseClassesGenWorker extends
	...
	private void generate_base_controler() throws Exception{
		...
		GpJavaServerDomainGenWorker domain_worker = super.get_generation_service().getDomain_gen_worker();

		ArrayList<String> imports = new ArrayList<String>();
		imports.add(domain_worker.getDomain_core_package_name() + ".GpUser");
	...
	private void generate_user_classes() throws Exception{
		...
		this.domain_gen_worker = super.get_generation_service().getDomain_gen_worker();
		core_domain_path = this.domain_gen_worker.getCore_domain_path();

		//first gen the user class
		ST st_user = super.read_template_group(this.user_template_group_path, "output");

		st_user.add("package_name", this.domain_gen_worker.getDomain_core_package_name());
		...
		st_auth.add("package_name", this.domain_gen_worker.getDomain_core_package_name());
		...
		st_base_auth.add("package_name", this.domain_gen_worker.getDomain_core_package_name());
	...
	private void handle_path_template_for_base_authority(){
		...
		String server_java_spring_legacy_base_user_authority_template_location = this.base_configs
			.get("server_java_spring_legacy_base_user_authority_template_location").getValue();


		tokens = this.tokenize_string(
				server_java_spring_legacy_base_user_authority_template_location, null);
		...
		if(server_java_spring_legacy_base_user_authority_template_path_config  == null){
			...
			String template_name =  this.base_configs.get(
					"server_java_spring_legacy_base_user_authority_template_name").getValue();
	...
	private void handle_path_template_for_authority(){
		...
		String spring_legacy_user_authority_template_location = this.base_configs
			.get("spring_legacy_user_authority_template_location").getValue();


		tokens = this.tokenize_string(
				spring_legacy_user_authority_template_location, null);
		...
		if(spring_legacy_user_authority_template_path_config  == null){
			...
			String template_name =  this.base_configs.get(
					"spring_legacy_user_authority_template_name").getValue();
	...
	private void handle_path_template_for_user(){
		...
		String server_java_spring_legacy_gp_user_template_location = this.base_configs
			.get("server_java_spring_legacy_gp_user_template_location").getValue();


		tokens = this.tokenize_string(
				server_java_spring_legacy_gp_user_template_location, null);
		...
		if(server_java_spring_legacy_gp_user_template_path_config  == null){
			...
			String template_name =  this.base_configs.get(
					"server_java_spring_legacy_gp_user_template_name").getValue();
