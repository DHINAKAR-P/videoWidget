 ...
 */
@Component("GpSpringBootServiceSearchHandler")
public class GpSpringBootServiceSearchHandler 
		extends GpBaseSpringBootServiceVerbFunctionHandler implements
	...
	public void gp_service_call(GpVerb verb,GpActivity activity) throws Exception {
		...
		GpJavaMethodDescription dao_method_sig_info = dao_sigs
				.get(GpBaseVerbsConstants.GpSearch).signiture_helper;
