...
@Component("GpExpressDaoCreateHandler")
public class GpExpressDaoCreateHandler 
extends GpBaseExpressdDaoVerbFunctionHandler
						implements IGpExpressDaoVerbGenSupport {
	...
	@Override
	public void gp_verb_key(GpVerb verb, GpActivity activity){
		the_dto.verb_key_name = GpSqlQueriesGenSupport.key_name_for_create;
	}
	...
	public void gp_sql_query(GpVerb verb,GpActivity activity) throws Exception {
		...
		the_dto.sequelizeQueryType = "INSERT";
	}
