...
import com.npb.gp.gen.workers.client.support.GpGenTemplateSupport;
@Component("GpGenTemplateWorker")
public class GpGenTemplateWorker extends GpGenBaseWorker{
	private GpGenTemplateSupport gen_support;
	...
	public GpGenTemplateSupport getGen_support() {
		return gen_support;
	}
	@Resource(name="GpGenTemplateSupport")
	public void setGen_support(GpGenTemplateSupport gen_support) {
