...
public class GpIonicToogle extends GpBaseHtmlGenInfo{
	GpBaseHtmlGenInfo parent;
	String screen_type;
	public GpIonicToogle(GpBaseHtmlGenInfo parent, String screen_type) {
		this.parent = parent;
	...
	public String get_html_tag() {
		...
		the_html += ">\n";
		the_html += "<div class=\"item item-toggle\">\n";
		the_html += widget.getLabel();  
		the_html += "\n<label class=\"toggle toggle-positive\">\n";
		the_html += "<input type=\"checkbox\">\n";
		the_html += "<div class=\"track\">\n";
		the_html += "<div class=\"handle\"></div>";
		the_html += "\n</div>\n</label>\n</div>\n</div>";
		return the_html;
	}
