...
import com.npb.gp.gen.workers.client.support.GpGenNielsenTemplateSupport;
@Component("GenNielsenTemplateWorker")
public class GenNielsenTemplateWorker extends GpGenBaseWorker{
	private GpGenNielsenTemplateSupport gen_support;
	...
	public GpGenNielsenTemplateSupport getGen_support() {
		return gen_support;
	}
	
	@Resource(name= "GpGenNielsenTemplateSupport")
	public void setGen_support(GpGenNielsenTemplateSupport gen_support) {
	...
	public void generate_asset() throws Exception{
		gen_support.handle_asset_generation_for_Nielsen_theme();
	}
	
	public void generate_nielsen_js() throws Exception{
		gen_support.handle_generate_nielsen_js_for_Nielsen_theme();
	}
	
	public void generate_fotorama_js() throws Exception{
		gen_support.handle_generate_fotorama_js_for_Nielsen_theme();
	}
}
