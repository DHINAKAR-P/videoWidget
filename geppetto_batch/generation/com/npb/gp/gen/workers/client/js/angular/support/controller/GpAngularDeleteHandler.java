 ...
 */
@Component("GpAngularDeleteHandler")
public class GpAngularDeleteHandler extends
	...
	public GpAngularControllerGenDto handle_verb(GpVerb verb, GpActivity activity) throws Exception {
		...
		try {
			//System.out.println("$$$$$$$$ In GpAngularDeleteHandler - handle_verb - verb id is: " + verb.getId());
