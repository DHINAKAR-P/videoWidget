...
public class GpIonicCheckBox extends GpBaseHtmlGenInfo {
	GpBaseHtmlGenInfo parent;
	String screen_type;
	public GpIonicCheckBox(GpBaseHtmlGenInfo parent, String screen_type) {
		this.parent = parent;
	...
	public String get_html_tag(){
		...
		the_html += "<ion-checkbox class=\"" + this.css_class + "\"";
		if(event != null){
		...
		the_html += "</ion-checkbox>\n</div>\n";
		return the_html;
	}

	@Override
	public void set_attributes() {
		css_class = "checkbox-element";
		int geppetto_X;
		int geppetto_Y;	
