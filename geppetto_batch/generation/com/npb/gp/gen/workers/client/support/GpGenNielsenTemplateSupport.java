...
@Component("GpGenNielsenTemplateSupport")
public class GpGenNielsenTemplateSupport {
	
	private GenNielsenTemplateWorker the_worker;
	...
	public GenNielsenTemplateWorker getThe_worker() {
		return the_worker;
	}

	@Resource(name = "GenNielsenTemplateWorker")
	public void setThe_worker(GenNielsenTemplateWorker the_worker) {
		this.the_worker = the_worker;
	}

	public void init() throws Exception {
		
		String[] templateName = getThe_worker().getGenService().getTemplateName().split(" ");
	...
	public void handle_css_generation_for_geppetto_theme() throws Exception {
		...
		//Kumaresan commented this code. because i get app.css form database
	...
	public void handle_asset_generation_for_Nielsen_theme() throws Exception{
	...
	public void handle_generate_nielsen_js_for_Nielsen_theme() throws Exception{
	...
	public void handle_generate_fotorama_js_for_Nielsen_theme() throws Exception{
		String directives_source_path = geppetto_theme_path + this.file_separator
				+ "fotorama_js";
		String root_path = getThe_worker().getGenService()
				.getDirectory_gen_worker().getWindows_root_directory_path().toString();
