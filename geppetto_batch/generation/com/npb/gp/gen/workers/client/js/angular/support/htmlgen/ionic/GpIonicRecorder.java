...
public class GpIonicRecorder  extends GpBaseHtmlGenInfo{
	GpBaseHtmlGenInfo parent;
	String screen_type;
	public GpIonicRecorder(GpBaseHtmlGenInfo parent, String screen_type) {
		this.parent = parent;
	...
	public String get_html_tag() {
		String the_html = "<button class=\"button button-clear icon-left ion-videocamera button-positive\" style=\"position: relative; height: 70vh; color : #ffc900 ;top: 62vh;\" data-ng-click=\"video_recorder()\">Upload Video</button>";
